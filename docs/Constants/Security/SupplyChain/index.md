...
icon: fontawesome/solid/truck-ramp-box
---

According to the [clean source principle](../Principles/CleanSource.md){ data-preview }, any dependencies of your system(s) need to be as secure as your system at a minimum.
